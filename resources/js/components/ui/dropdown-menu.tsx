...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-[200] min-w-[8rem] overflow-hidden rounded-md border border-[var(--color-border)]',
      'bg-[var(--color-bg-surface)] p-1 shadow-md',
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    className={cn(
      ...
      'transition-colors focus:bg-[var(--color-bg-subtle)]',
      'data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
      className,
    )}
    checked={checked}
